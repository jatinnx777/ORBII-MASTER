...
//
// NOTE: In-app SUBSCRIPTION purchases were removed. Google Play requires Google
// Play Billing for digital subscriptions, so paid plans are handled elsewhere
// (Play Billing, planned) or on the website. The only Razorpay use left here is
// the voluntary helper TIP below, which pays a real person for real-world help
// and is permitted outside Play Billing.
