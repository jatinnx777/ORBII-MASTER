...
class SupabaseConfig {
  ...
  /// OAuth redirect — MUST exactly match the RN app's value, which is the one
  /// already allow-listed in Supabase (Auth → URL Configuration) and on the
  /// Google OAuth client. Registered in AndroidManifest.xml.
  static const authRedirect = 'orbii://auth/callback';
}
